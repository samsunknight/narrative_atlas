"""GENERATION STEP (not part of reproduce.py). One-attribute-at-a-time scoring variant;
requires raw plot text (inputs/) and an OpenAI API key, neither included in this release.
The shipped scored corpus is the output.
