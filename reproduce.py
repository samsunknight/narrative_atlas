...
chk("R", "reception spectacle->votes",   0.28, partial(M,"spectacle","lvotes"), 0.03)
chk("R", "reception spectacle->rating",  0.25, partial(M,"spectacle","rating"), 0.03)
chk("R", "reception fashion->rating",    0.46, partial(M,"fashion","rating"), 0.03)
chk("R", "reception fashion->votes",     0.03, partial(M,"fashion","lvotes"), 0.03)
chk("R", "reception spectacle_v->votes", 0.19, partial(M,"spectacle_v","lvotes"), 0.03)
chk("R", "reception spectacle_v->rating",0.07, partial(M,"spectacle_v","rating"), 0.03)
chk("R", "reception fashion_v->rating",  0.37, partial(M,"fashion_v","rating"), 0.03)
chk("R", "reception fashion_v->votes",  -0.01, partial(M,"fashion_v","lvotes"), 0.03)
