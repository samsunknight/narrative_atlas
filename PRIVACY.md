...
(protocol 46547): a book survey (714 readers; the HumanReader corpus) and two film surveys
(225 viewers; the HumanViewer corpus). Participants gave informed consent and were
compensated. The **raw** per-respondent responses will be released with those companion dataset papers
